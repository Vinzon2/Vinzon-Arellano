            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="relative mb-8">
                  ...
                  >
                    <div className="bg-tech-surface border border-tech-accent p-4 rounded-xl shadow-[0_0_20px_rgba(0,100,65,0.2)]">
                ...
                <motion.p 
                  className="text-gray-100 text-lg max-w-xl mb-10 leading-relaxed"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
  ...
  <div className="mb-6 flex gap-2">
    ...
    >
      Admin Login
          ...
          {/* Resume Section */}
      <section id="resume" className="py-20 bg-tech-accent">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <h2 className="text-4xl md:text-6xl font-bold text-black mb-6 tracking-tight">Ready to build something great?</h2>
          ...
          <a 
            ...
            download="https://github.com/Vinzon2/Vinzon-Arellano/blob/main/src/public/Vinzon%20Arellano.pdf"
